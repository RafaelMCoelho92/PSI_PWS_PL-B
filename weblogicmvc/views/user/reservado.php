    ...
    <form class="form-horizontal">
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input value="<?php if (isset($user)) {echo $user->email;} ?>" type="email" class="form-control" name="email" id="inputEmail3" placeholder="Email">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Nova Password</label>
                <div class="col-sm-10">
                    <input value="<?php if (isset($user)) {echo $user->password;} ?>" type="password" class="form-control" name="password" id="inputPassword3" placeholder="Password">
                </div>
            </div>
        </div>
